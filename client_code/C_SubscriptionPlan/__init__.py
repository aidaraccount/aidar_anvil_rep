...
class C_SubscriptionPlan(C_SubscriptionPlanTemplate):
  def __init__(self, **properties):
    ...
    self.explore_btn.add_class("cta-primary")
    self.explore_btn.add_class("center")
    self.professional_btn.add_class("cta-primary")
    self.professional_btn.add_class("center")
