from ._anvil_designer import ObserveTemplateTemplate
from anvil import *
import anvil.server
import anvil.users
...
class ObserveTemplate(ObserveTemplateTemplate):
  ...
  #   if c is True:
  #     anvil.server.call(
  #       "delete_reference", self.model_id_view, self.item[0]["ArtistID"]
  #     )

  #     # SOURCE INDIVIDUAL CODE
  #     if anvil.js.window.location.hash.lstrip("#").split("?")[0] == "model_setup":
  #       self.parent.parent.parent.parent.parent.parent.next_role(
  #         section="Reference_Artists"
  #       )
  ...
  #   if c is True:
  #     anvil.server.call(
  #       "delete_reference", self.model_id_view, self.item[1]["ArtistID"]
  #     )
  ...
  #   if c is True:
  #     anvil.server.call(
  #       "delete_reference", self.model_id_view, self.item[2]["ArtistID"]
  #     )
